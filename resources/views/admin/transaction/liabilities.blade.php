            ...
            <div class="card card-secondary">
              ...
              <div class="card-body">
                <form id="createThisForm">
                  ...
                  <input type="hidden" class="form-control" id="table_type" name="table_type" value="Liabilities">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    {{-- <td style="text-align: center">{{$data->chartofaccount->id ?? 'None'}}</td> --}}
                    <td style="text-align: center">{{\App\Models\ChartOfAccount::where('id',$data->chart_of_account_id)->first()->account_name}}</td>
